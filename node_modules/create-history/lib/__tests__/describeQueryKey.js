...
var describeQueryKey = function describeQueryKey(createHistory) {
  describe('when queryKey == "a"', function () {
    var history = void 0;
    beforeEach(function () {
    ...
    it('remembers state across transitions', function (done) {
      var steps = [function (location) {
        ...
        (0, _expect2.default)(location.pathname).toEqual('/home');
        (0, _expect2.default)(location.search).toEqual('?the=query');
        (0, _expect2.default)(location.state).toEqual({ the: 'state' }); // State is present
        (0, _expect2.default)(location.action).toEqual(_Actions.POP);
        (0, _expect2.default)(location.key).toExist();
      }];
